...
0000111B  C3                ret
0000111C  C3                ret
0000111D  2ED906651C        fld dword [cs:0x1c65]
00001122  2ED81E611C        fcomp dword [cs:0x1c61]
00001127  DFE0              fnstsw ax
00001129  9B9E              wait sahf
0000112B  720F              jc 0x113c
0000112D  662EA1611C        mov eax,[cs:0x1c61]
00001132  662EA3651C        mov [cs:0x1c65],eax
00001137  2E8936691C        mov [cs:0x1c69],si
0000113C  C3                ret
0000113D  2EC706691C5F16    mov word [cs:0x1c69],0x165f
00001144  662EA1051C        mov eax,[cs:0x1c05]
00001149  662EA3651C        mov [cs:0x1c65],eax
0000114E  2E8B366116        mov si,[cs:0x1661]
00001153  2E8B4CFE          mov cx,[cs:si-0x2]
00001157  51                push cx
00001158  56                push si
00001159  2E8B5C02          mov bx,[cs:si+0x2]
0000115D  2EFF14            call word [cs:si]
00001160  7303              jnc 0x1165
00001162  E8B8FF            call word 0x111d
00001165  5E                pop si
00001166  59                pop cx
00001167  83C604            add si,byte +0x4
0000116A  E2EB              loop 0x1157
0000116C  C3                ret
...
0000118D  C3                ret
0000118E  662EC706731CC0FF  mov dword [cs:0x1c73],0xffffffc0
         -FFFF
00001198  B94100            mov cx,0x41
0000119B  51                push cx
0000119C  B95100            mov cx,0x51
0000119F  662EC7066F1C60FF  mov dword [cs:0x1c6f],0xffffff60
         -FFFF
000011A9  51                push cx
...
00001222  2EDB06D513        fild dword [cs:0x13d5]
...
000012CD  E202              loop 0x12d1
000012CF  EB03              jmp short 0x12d4
000012D1  E94EFF            jmp word 0x1222
000012D4  C3                ret
